...
It started not with a social app, but with a game. We're building something called *Fractured Echoes*. A fractured ring world, where the single shards are drifting away into a void creating a very interesting gameplay for everyone who loves such games. We needed a voice and social platform to go with it and for us trying to build that platform first sounded like a good idea, since we can figure out an architecture and a core server stack and then build our game networking around that.
